...
oceanpayment AliPayHK payment  plugin

== Description ==
oceanpayment AliPayHK payment  plugin

== Installation ==
1.install the Oceanpayment-AliPayHK plug-in in the WordPrwss background.
2.Activate oceanpayment AliPayHK in the plugin menu.
